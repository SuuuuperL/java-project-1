...
//            TcpDiscoveryVmIpFinder ipFinder = new TcpDiscoveryVmIpFinder();
        ...
        cfg.setDiscoverySpi(new TcpDiscoverySpi().setLocalPort(47500).setLocalPortRange(10).setIpFinder(ipFinder));
        // 不可以和服务端的节点冲突
        cfg.setCommunicationSpi(new TcpCommunicationSpi().setLocalPort(47101));
        cfg.setClientConnectorConfiguration(new ClientConnectorConfiguration().setPort(10701));
        ignite = Ignition.start(cfg);
